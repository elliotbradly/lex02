...
export default class NameArc extends Arc {
  ...
  create = (dat: string) => this.path.move(this.state, Act.CREATE_NOM, dat);
  write = (dat: GlopBit) => this.path.move(this.state, Act.WRITE_NAMES, dat);
}
